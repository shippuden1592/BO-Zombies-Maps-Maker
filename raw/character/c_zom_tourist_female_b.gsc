...
main()
{
	self setModel("c_tourist_female_b_fullbody");
	self.headModel = "c_tourist_female_b_fullbody_head";
...
precache()
{
	precacheModel("c_tourist_female_b_fullbody");
	precacheModel("c_tourist_female_b_fullbody_head");
