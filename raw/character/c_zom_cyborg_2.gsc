...
main()
{
	self setModel("c_zom_garbageman_body_orange");
	self.headModel = "c_zom_garbageman_head";
	self attach(self.headModel, "", true);
	self.voice = "american";
	self.skeleton = "base";
	self.torsoDmg1 = "c_zom_garbageman_body_upclean";
	self.torsoDmg2 = "c_zom_garbageman_body_rarmoff_2";
	self.torsoDmg3 = "c_zom_garbageman_body_larmoff_2";
	self.torsoDmg5 = "c_zom_garbageman_body_behead";
	self.legDmg1 = "c_zom_garbageman_body_lowclean";
	self.legDmg2 = "c_zom_garbageman_body_rlegoff_2";
	self.legDmg3 = "c_zom_garbageman_body_llegoff_2";
...
precache()
{
	precacheModel("c_zom_garbageman_body_orange");
	precacheModel("c_zom_garbageman_head");
	precacheModel("c_zom_garbageman_body_upclean");
	precacheModel("c_zom_garbageman_body_rarmoff_2");
	precacheModel("c_zom_garbageman_body_larmoff_2");
	precacheModel("c_zom_garbageman_body_behead");
	precacheModel("c_zom_garbageman_body_lowclean");
	precacheModel("c_zom_garbageman_body_rlegoff_2");
	precacheModel("c_zom_garbageman_body_llegoff_2");
