...
main()
{
	self setModel("c_tourist_male_b_fullbody");
	self.headModel = "c_tourist_male_b_fullbody_head";
...
precache()
{
	precacheModel("c_tourist_male_b_fullbody");
	precacheModel("c_tourist_male_b_fullbody_head");
