...
main()
{
	self setModel("c_pirate_male_a_fullbody");
	self.headModel = "c_pirate_male_b_fullbody_head";
...
precache()
{
	precacheModel("c_pirate_male_a_fullbody");
	precacheModel("c_pirate_male_b_fullbody_head");
