...
//	PrecacheItem( "zombie_melee" );
	...
	// Special                                          	
 	...
 	//POWER_UP_MINIGUN
 	add_zombie_weapon( "minigun_zm", 				"minigun_upgraded_zm", 					&"ZOMBIE_WEAPON_THUNDERGUN", 			2500, 	"assault" );
...
weapon_spawn_think()
{
	...
	for( ;; )
	{
		...
		//PERK_CUSTOM_WIDOWS_GRENADE
		if( player maps\_zombiemode_perks_custom::widows_wine_override_wallbuy_purchase( self.zombie_weapon_upgrade ) )
		{
			self.zombie_weapon_upgrade = level.zombie_vars["widows_wine_grenade"];
		}
		else
		{
			if( is_lethal_grenade( self.zombie_weapon_upgrade ) )
				self.zombie_weapon_upgrade = level.zombie_vars["widows_wine_grenade_backup"];
		}
