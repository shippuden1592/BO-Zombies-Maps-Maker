...
/*QUAKED actor_zombie_minecraft (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_zom_minecraft_body"
...
main()
{
	...
	character\c_zombie_minecraft::main();
}
...
precache()
{
	character\c_zombie_minecraft::precache();
